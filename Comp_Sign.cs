...
namespace Dark.Signs
{
    public class Comp_Sign : ThingComp, IRenameable
    {
        ...
        private bool _doneBaseLabel = false;
        ...
        private string GetBaseLabelRaw()
        {
            ...
            {
                _doneBaseLabel = true;
                _baseLabel = this.Props == null ? "Empty sign" : this.Props.defaultContents;
            }
            return _baseLabel;
        }
        public string RenamableLabel
        {
            get => this.signContent ?? GetBaseLabelRaw();
            set => this.signContent = value;
        }
